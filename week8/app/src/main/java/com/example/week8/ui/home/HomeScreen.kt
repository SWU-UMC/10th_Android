package com.example.week8.ui.home
...
import com.example.week8.model.ProductUiModel
import com.example.week8.ui.component.ProductHorizontalCard
    ...
    LazyColumn(
        ...
        item(contentType = "header") {
            Column(modifier = Modifier.padding(horizontal = 34.dp)) {
                androidx.compose.foundation.layout.Spacer(modifier = Modifier.height(52.dp))
                Text(
                    text = "Discover",
                    color = Black,
                    fontSize = 24.sp,
