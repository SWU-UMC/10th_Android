...
public abstract class Hilt_SaleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SaleFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SaleFragment_GeneratedInjector) this.generatedComponent()).injectSaleFragment(UnsafeCasts.<SaleFragment>unsafeCast(this));
    }
  }
