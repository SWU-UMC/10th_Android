...
public abstract class Hilt_ProductDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductDetailFragment() {
    super();
  }

  Hilt_ProductDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductDetailFragment_GeneratedInjector) this.generatedComponent()).injectProductDetailFragment(UnsafeCasts.<ProductDetailFragment>unsafeCast(this));
    }
  }
