...
public abstract class Hilt_ShopFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShopFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShopFragment_GeneratedInjector) this.generatedComponent()).injectShopFragment(UnsafeCasts.<ShopFragment>unsafeCast(this));
    }
  }
