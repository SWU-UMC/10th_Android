...
public abstract class Hilt_WishlistFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WishlistFragment() {
    super();
  }

  Hilt_WishlistFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WishlistFragment_GeneratedInjector) this.generatedComponent()).injectWishlistFragment(UnsafeCasts.<WishlistFragment>unsafeCast(this));
    }
  }
