...
public abstract class Hilt_TopFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TopFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TopFragment_GeneratedInjector) this.generatedComponent()).injectTopFragment(UnsafeCasts.<TopFragment>unsafeCast(this));
    }
  }
