...
public final class ProductRepositoryImpl implements com.example.nike.domain.repository.ProductRepository {
    ...
    @org.jetbrains.annotations.NotNull()
    private final kotlinx.coroutines.flow.Flow<java.util.List<com.example.nike.data.repository.ProductUiModel>> allProducts = null;
    ...
    @java.lang.Override()
    @org.jetbrains.annotations.NotNull()
    public kotlinx.coroutines.flow.Flow<java.util.List<com.example.nike.data.repository.ProductUiModel>> getAllProducts() {
        return null;
    }
    ...
    private final com.example.nike.data.repository.ProductUiModel toUiModel(com.example.nike.data.model.Product $this$toUiModel, boolean isLiked) {
        return null;
    }
}